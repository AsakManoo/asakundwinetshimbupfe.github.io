  ...
  return (
    ...
    >
      ...
      <p className="mt-6 max-w-3xl text-pretty text-lg leading-relaxed text-white/90 md:text-xl">
        ...
        don&apos;t just write code; I build digital products that solve user
        problems. Currently looking to bring my technical skills and
        collaborative mindset to a fast-paced engineering team.
      </p>
    </section>
  )
}
